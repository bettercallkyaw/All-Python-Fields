...
print(f'captain_cook is the instance of Penguin: {isinstance(captain_cook,Penguin)}')
print(f'captain_cook is the instance of Aquatic: {isinstance(captain_cook,Aquatic)}')
print(f'captain_cook is the instance of Ambulatory: {isinstance(captain_cook,Ambulatory)}')
